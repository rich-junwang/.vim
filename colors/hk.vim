" Vim color profile,  based on nightsky and candycode
" Maintainer:   Kun He
" Last Change:  
...
if &t_Co == "256"
	...
	hi Search		ctermfg=226 ctermbg=54
	...
	hi IncSearch	ctermbg=darkblue ctermfg=cyan
endif
...
if &t_Co == "256"
	...
	hi Folded		ctermfg=lightmagenta ctermbg=darkblue
...
if &t_Co == "256"
	...
	hi MatchParen	ctermfg=white ctermbg=darkgreen
else
